...
namespace Engine
{
	...
	void CPlayers::Update()
	{
		...
		for (BYTE EntIndex = 0; EntIndex < GetSize(); EntIndex++)
		{
			...
			{
				if (Settings::Esp::esp_SkeletonStyle == 0)
				{
					// BODY
					GetHitBoxSkeleton(HITBOX_HEAD, HITBOX_NECK, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[0]);
					GetHitBoxSkeleton(HITBOX_UPPER_CHEST, HITBOX_CHEST, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[1]);
					GetHitBoxSkeleton(HITBOX_CHEST, HITBOX_THORAX, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[2]);
					GetHitBoxSkeleton(HITBOX_THORAX, HITBOX_BODY, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[3]);

					// RIGHT LEG
					GetHitBoxSkeleton(HITBOX_BODY, HITBOX_LEFT_THIGH, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[4]);
					GetHitBoxSkeleton(HITBOX_LEFT_THIGH, HITBOX_LEFT_CALF, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[5]);
					GetHitBoxSkeleton(HITBOX_LEFT_CALF, HITBOX_LEFT_FOOT, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[6]);

					// LEFT LEG
					GetHitBoxSkeleton(HITBOX_BODY, HITBOX_RIGHT_THIGH, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[7]);
					GetHitBoxSkeleton(HITBOX_RIGHT_THIGH, HITBOX_RIGHT_CALF, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[8]);
					GetHitBoxSkeleton(HITBOX_RIGHT_CALF, HITBOX_RIGHT_FOOT, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[9]);

					// RIGHT ARM
					GetHitBoxSkeleton(HITBOX_CHEST, HITBOX_LEFT_UPPER_ARM, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[10]);
					GetHitBoxSkeleton(HITBOX_LEFT_UPPER_ARM, HITBOX_LEFT_FOREARM, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[11]);
					GetHitBoxSkeleton(HITBOX_LEFT_FOREARM, HITBOX_LEFT_HAND, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[12]);

					// LEFT ARM
					GetHitBoxSkeleton(HITBOX_CHEST, HITBOX_RIGHT_UPPER_ARM, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[13]);
					GetHitBoxSkeleton(HITBOX_RIGHT_UPPER_ARM, HITBOX_RIGHT_FOREARM, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[14]);
					GetHitBoxSkeleton(HITBOX_RIGHT_FOREARM, HITBOX_RIGHT_HAND, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[15]);
				}
				else if (Settings::Esp::esp_SkeletonStyle == 1)
				{
					// BODY
					GetHitBoxSkeleton(HITBOX_HEAD, HITBOX_NECK, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[0]);
					GetHitBoxSkeleton(HITBOX_UPPER_CHEST, HITBOX_CHEST, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[1]);
				...
				else if (Settings::Esp::esp_SkeletonStyle == 2)
				{
					GetHitBoxSkeleton(HITBOX_HEAD, HITBOX_NECK, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[0]);
					GetHitBoxSkeleton(HITBOX_UPPER_CHEST, HITBOX_CHEST, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[1]);
					GetHitBoxSkeleton(HITBOX_CHEST, HITBOX_THORAX, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[2]);
					...
					// RIGHT ARM
					GetHitBoxSkeleton(HITBOX_CHEST, HITBOX_LEFT_UPPER_ARM, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[4]);
					GetHitBoxSkeleton(HITBOX_LEFT_UPPER_ARM, HITBOX_LEFT_FOREARM, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[5]);
					GetHitBoxSkeleton(HITBOX_LEFT_FOREARM, HITBOX_LEFT_HAND, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[6]);

					// LEFT ARM
					GetHitBoxSkeleton(HITBOX_CHEST, HITBOX_RIGHT_UPPER_ARM, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[7]);
					GetHitBoxSkeleton(HITBOX_RIGHT_UPPER_ARM, HITBOX_RIGHT_FOREARM, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[8]);
					GetHitBoxSkeleton(HITBOX_RIGHT_FOREARM, HITBOX_RIGHT_HAND, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[9]);
				}
				else if (Settings::Esp::esp_SkeletonStyle == 3)
				{
					GetHitBoxSkeleton(HITBOX_HEAD, HITBOX_NECK, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[0]);
					GetHitBoxSkeleton(HITBOX_UPPER_CHEST, HITBOX_CHEST, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[1]);
					GetHitBoxSkeleton(HITBOX_CHEST, HITBOX_THORAX, pEntity, m_pPlayers[EntIndex].vHitboxSkeletonArray[2]);
