...
namespace ImGui
{
	...
	IMGUI_API bool          MyButtonEx(const char* label, bool inuse, const ImVec2& size_arg, ImGuiButtonFlags flags);
	IMGUI_API bool          AndroidButtonEx(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
